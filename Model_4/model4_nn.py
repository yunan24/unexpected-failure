...
def testmodel3(testing_dataset):
	dataset_model_1 = open('Model4_Splitdata1.csv', 'w+') #no outliers
	dataset_model_2 = open('Model4_Splitdata2.csv', 'w+') #outliers
	...
	for line in open(testing_dataset):
		...
		if outlierboolean == True: #True=outliers False = no outliers
			append_list_as_row('Model4_Splitdata2.csv', csv_row_full)
		elif outlierboolean == False:
			append_list_as_row('Model4_Splitdata1.csv', csv_row_full)


	#feed data to models
	MODEL_1_DATASET = 'Model4_Splitdata1.csv'
	MODEL_2_DATASET = 'Model4_Splitdata2.csv'
	...
	model_1_data_empty = os.stat('Model4_Splitdata1.csv').st_size == 0 #True if empty, False if not
	model_2_data_empty = os.stat('Model4_Splitdata2.csv').st_size == 0
	...
	print("\n\n-------------------------------------------------------------------------------------------------------")
	print('Final MSE for Model 4: %.3f' %(FinalMSE))
